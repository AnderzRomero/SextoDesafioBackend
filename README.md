...
> 4. Ejecuta el comando `npm install express express-handlebars socket.io nodemon mongoose multer dotenv mongoose-paginate-v2 cookie-parser express-session connect-mongo bcrypt passport passport-local passport-github2` para instalar las dependencias necesarias para el funcionamiento.
